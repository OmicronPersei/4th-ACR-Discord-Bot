...
#                         "main_request_channel": "2349234923"
#                         "available_roles": [
#                             {
#                                 "role": "1111",
...
#         self.mock_roles_availabe_provider.get_roles_for_channel = MagicMock(return_value=[self.politics_role, self.funstuff_role])
#         self.mock_message = create_mock_message("!roles", "the_channel", channel_id=2349234923)
